/* 
    GDG Progrmación basica JS

    --------------DOM----------------
    El DOM es una representación completamente orientada al objetos de la página web y puede ser modificado con un lenguaje de script como JavaScript.
